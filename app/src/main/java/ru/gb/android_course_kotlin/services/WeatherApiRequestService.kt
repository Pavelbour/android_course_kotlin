...
import ru.gb.android_course_kotlin.ui.details.*
...
class WeatherApiRequestService : IntentService("WeatherApiRequestService") {
    ...
    private fun onResponse(weatherDTO: WeatherDTO) {
        ...
        if (fact == null) {
            ...
            onSuccessRespons(fact.temp, fact.feelsLike, fact.condition)
        }
    }

    private fun onSuccessRespons(temp: Int?, feelsLike: Int?, condition: String?) {
